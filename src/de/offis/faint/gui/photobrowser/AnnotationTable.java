...
//			this.fireTableStructureChanged();
        ...
        public int getColumnCount() {
            if (imageModel == null || MainController.getInstance().getFaceDB().getRegionsForImage(imageModel.getFile().toString()) == null)
                return 0;
            else
                return MainController.getInstance().getFaceDB().getRegionsForImage(imageModel.getFile().toString()).length;
        }
