 ...
 */
public class HelloSapi4 extends javax.swing.JFrame {
    
    Synthesizer synth = null;
    Voice voice = null;
    
    /** Creates new form HelloSapi4 */
    public HelloSapi4() {
	initComponents();
	try {
		...
		for(int j=0;j<voices.length;j++) {
		    if(voices[j].getName().indexOf("SAPI4") > 0) {
			voice = voices[j];
			break;
		    }
		}
	    ...
	    if(voice == null) {
		System.out.println("Unable to find a SAPI4 voice - quitting");
		System.exit(0);
	    }
